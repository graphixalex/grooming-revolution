...
const faqs = [
  ...
  {
    q: "Gestisce piu sedi?",
    a: "Si. Ogni sede mantiene dati separati, con controllo aggregato per owner/manager.",
  },
  {
    ...
    <main className={`${bodyFont.className} pro-landing min-h-screen`}>
      <section className="pro-hero relative isolate min-h-[100svh] overflow-hidden px-4 pb-12 pt-4 sm:px-6 md:px-10">
        ...
        <div className="mx-auto flex w-full max-w-[1360px] flex-col">
          <header className="flex items-center justify-between gap-3 rounded-2xl border border-white/40 bg-white/65 px-3 py-2 backdrop-blur md:px-5">
        ...
        <div className="mx-auto w-full max-w-[1360px]">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {modules.map((item) => {
              ...
              return (
                <article key={item.title} className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-[0_12px_28px_rgba(15,23,42,0.07)]">
      ...
      <section className="w-full bg-zinc-950 px-4 py-12 text-zinc-100 sm:px-6 md:px-10 md:py-16">
        <div className="mx-auto grid w-full max-w-[1360px] gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-2">
            {setup.map((step, idx) => (
              <div key={step} className="flex items-start gap-3 rounded-xl border border-zinc-800 bg-zinc-900/80 p-3">
      ...
      <section className="px-4 py-12 sm:px-6 md:px-10 md:py-16">
        <div className="mx-auto grid w-full max-w-[1360px] gap-4 lg:grid-cols-2">
          <article className="rounded-3xl border border-cyan-200 bg-gradient-to-br from-cyan-50 to-white p-5 md:p-7">
          ...
          <article className="rounded-3xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-5 md:p-7">
            ...
            <ul className="mt-4 space-y-2 text-sm text-zinc-700">
              ...
              <li className="inline-flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-600" />Durata servizi per taglia/trattamenti</li>
      ...
      <footer className="w-full bg-zinc-950 px-4 py-8 text-zinc-200 sm:px-6 md:px-10">
        ...
        <p className="mx-auto mt-6 w-full max-w-[1360px] text-xs text-zinc-500">© {new Date().getFullYear()} Grooming Revolution. Tutti i diritti riservati.</p>
      </footer>
    </main>
  );
}
