...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-amber-400 to-amber-500 text-zinc-900 shadow-sm hover:-translate-y-0.5 hover:from-amber-300 hover:to-amber-400 hover:shadow-md",
