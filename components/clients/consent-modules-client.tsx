      ...
      {selectedClient ? (
        <>
          <Card className="space-y-2">
            ...
            <p className="text-xs text-zinc-600">Privacy resta in scheda cliente. Qui gestisci Anamnesi e Nodi + archivio PDF moduli.</p>
          </Card>

          <ClientAnamnesisCard clientId={selectedClient.id} />
          <ClientMattingConsentCard clientId={selectedClient.id} />
